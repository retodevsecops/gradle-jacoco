...
public class GetSignedDocumentUtil {
    ...
    private static final String REQUEST = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
            ...
            "  </soap:Body>\n" +
            "</soap:Envelope>";
    private static final String REGEX_SUCCESS_RESPONSE = "<GETDocFirmadoResult>(.*?)</GETDocFirmadoResult>";
